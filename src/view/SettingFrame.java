...
public class SettingFrame extends MyFrame{
    ...
    public SettingFrame(GameSettings settings){
    ...
    private static JPanel getMusicPanel() {
        ...
        soundSlider.addChangeListener(e -> MenuFrame.setVolume(soundSlider.getValue()));
    ...
    private JPanel getCustomPanel(){
        ...
        detailDialogCheckBox.setSelected(settings.verboseDialogs());
        detailDialogCheckBox.addActionListener(e -> settings.setVerboseDialogs(detailDialogCheckBox.isSelected()));
        JCheckBox autoRestartCheckBox = new JCheckBox("Auto restart when game ends");
        autoRestartCheckBox.setSelected(settings.autoRestart());
        autoRestartCheckBox.addActionListener(e -> settings.setAutoRestart(autoRestartCheckBox.isSelected()));
